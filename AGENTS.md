...
Run the style check **before** the text UI tests below. A style fix can change what the program prints, and the tests have to run against the code as it will be left, not as it was midway through.
